  ...
  return (
    <div className="w-full max-w-sm space-y-6 animate-[fade-in_0.4s_ease-out]">
      <div className="flex flex-col items-center gap-3">
        <div className="flex h-14 w-14 items-center justify-center rounded-2xl bg-slate-900 shadow-lg dark:bg-slate-700">
      ...
      <Card className="shadow-sm">
        ...
        <CardContent>
          <form action={action} className="space-y-4">
            ...
            {state?.error && (
              <div className="rounded-xl bg-red-50 border border-red-200 px-4 py-3 dark:bg-red-950/30 dark:border-red-800">
