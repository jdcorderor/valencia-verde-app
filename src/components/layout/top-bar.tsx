...
import {
  Sun, Moon, Menu, X, Flame, PlusCircle, FileText, Phone, User, LogOut,
} from "lucide-react";
    ...
    <>
      ...
      >
        ...
        <button
          ...
          className="flex h-9 w-9 items-center justify-center rounded-xl hover:bg-[--color-accent] transition-colors text-[--color-muted-foreground] hover:text-[--color-foreground] flex-shrink-0"
          title="Cambiar tema"
      ...
      >
            ...
            return (
              <Link
                ...
                className={cn(
                  ...
                  active
                    ? "bg-green-100 dark:bg-green-900/20 text-[--color-primary]"
        ...
        <div className="flex-shrink-0 p-3 border-t border-[--color-border]">
          <form action={signOut}>
            <button
              type="submit"
              className="flex w-full items-center gap-3 px-4 py-3 rounded-xl text-sm font-medium text-[--color-muted-foreground] hover:text-red-600 hover:bg-red-50 dark:hover:bg-red-950/20 transition-all"
            >
