          ...
          return (
            <Link
              ...
              className={cn(
                ...
                active
                  ? "bg-green-100 dark:bg-green-900/20 text-[--color-primary] font-semibold"
      ...
      <div className="p-3 border-t border-[--color-border] space-y-1">
        ...
        <form action={signOut}>
          <Button
            type="submit"
            variant="ghost"
            className="w-full justify-start gap-3 text-[--color-muted-foreground] hover:text-red-600 hover:bg-red-50 dark:hover:bg-red-950/20 rounded-xl h-9 px-3 text-sm"
          >
