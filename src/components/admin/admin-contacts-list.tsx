...
export function AdminContactsList({
 ...
 className="flex h-7 w-7 items-center justify-center rounded-lg text-[--color-muted-foreground] hover:bg-red-50 hover:text-red-600 transition-colors"
 title="Eliminar"
 >
 ...
 <button
 onClick={() => setDeleting(contact)}
 className="flex h-8 w-8 items-center justify-center rounded-lg text-[--color-muted-foreground] hover:bg-red-50 hover:text-red-600 transition-colors"
 >
 <Trash2 className="h-3.5 w-3.5" />
 </button>
 </div>
