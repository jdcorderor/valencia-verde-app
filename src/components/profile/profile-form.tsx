...
export function ProfileForm({ profile, email }: { profile: UserType; email: string }) {
 ...
 {state?.success && (
 <div className="flex items-center gap-2.5 rounded-xl bg-green-50 border border-green-100 px-4 py-3 animate-[scale-in_0.2s_ease-out]">
 ...
 variant="outline"
 size="lg"
 className="w-full rounded-2xl font-semibold text-[--color-destructive] border-[--color-destructive]/25 hover:bg-red-50 hover:border-[--color-destructive]/50"
 >
 Cerrar Sesión
 </Button>
 </form>
