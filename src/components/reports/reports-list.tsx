...
> = {
  forest:     { label: "Forestal",    icon: Trees,      color: "text-green-600 dark:text-green-400"  },
  urban:      { label: "Urbano",      icon: Building2,  color: "text-blue-600 dark:text-blue-400"    },
  industrial: { label: "Industrial",  icon: Factory,    color: "text-orange-600 dark:text-orange-400" },
  grassland:  { label: "Pastizal",    icon: Wheat,      color: "text-yellow-600 dark:text-yellow-400" },
  other:      { label: "Otro",        icon: HelpCircle, color: "text-slate-600 dark:text-slate-400"  },
};
